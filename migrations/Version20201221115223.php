 ...
 */
final class Version20201221115223 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE login (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, usuario VARCHAR(255) NOT NULL COLLATE BINARY, clave VARCHAR(255) NOT NULL COLLATE BINARY)');
